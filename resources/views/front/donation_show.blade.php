...
@section('content')
    <div class="container">
        ...
        <nav class="my-5" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="donation.html">طلبات التبرع</a></li>
        ...
        <div class="container">
            <div class="Status-info p-3 my-4">
                <div class="row">
                    ...
                    <div class="col-md-6 clearfix">
                        <p class="status float-right p-3">المسشفى</p>
                ...
                <div class="border p-3 my-3">
                    <p class="my-md-2"> {{$donation->notes}}
                    </p>
                    
                </div>
                <!--Location on Google-->
                <div class = "locaiton" style="width: 100%; height: 400px;" data-latitude = {{$donation->latitude}}  data-longitude = {{$donation->longitude}}>
  ...
  @push('scripts')
    <script>
        $('.locaiton').locationpicker({
            location: {
                latitude: $('.locaiton').data("latitude"),
                longitude: $('.locaiton').data("longitude")
            },
            radius: 300
        });
    </script>
