...
<section class="content-header">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <a href = {{url(route('city.create'))}} class = "btn btn-primary"><i class = "fa fa-plus"></i>  New City</a><br><br>
          @if(count($records) > 0)
                        ...
                        @foreach($records as $record)
                            <tr>
                                ...
                                <td class = "text-center">
                                    <a href = "{{url(route('city.edit' , $record->id))}}" class = "btn btn-success btn-sm"><i class = "fa fa-edit"></i></a>
                                </td>
                                <td class = "text-center">
